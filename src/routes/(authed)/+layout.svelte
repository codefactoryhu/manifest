...
{#if isAuthenticated}
	...
	>
		...
		<div class="flex items-center gap-1 sm:gap-2">
			...
			<button
				id="avatar-menu"
				class="flex h-9 flex-wrap items-center gap-x-2 rounded-lg border-gray-100 bg-gray-50 px-4 text-tmainl hover:bg-gray-100 focus:outline-none dark:border-gray-100 dark:bg-bgdf dark:text-white dark:hover:border-gray-600 dark:hover:bg-gray-700 dark:focus:ring-gray-700"
			>
