...
export default {
	...
	theme: {
		...
		extend: {
			...
			colors: {
				// Background:
				bgl: '#f1f5f9', // Light background
				bgd: '#111827', // Dark background
				bgls: '#ffffff', // Light secondary background // bg-white
				bgds: '#1f2937', // Dark secondary background // gray-800
				bglt: '#e5e5e5', // Light third background
				bgdt: '#030713', // Dark third background
				bglf: '#f3f4f6', // Light fourth background // gray-100
				bgdf: '#374151', // Dark fourth background // gray-700

				// Hover-Background:
				hlbg: '#f1f5f9', // Light background hover // slate-100
				hdbg: '#374151', // Dark background hover // gray-700

				// Text:
				tmainl: '#000000', // Light text main
				tsecl: '#6b7280', // Text secondary // gray-500
				tmaind: '#ffffff', // Dark text main
				tsecd: '#9ca3af', // Text secondary // gray-400

				// Hover-Text:
				htl: '#2563eb', // Light text hover // blue-600
				htd: '#93c5fd', // Dark text hover // blue-300

				// Border:
				brl100: '#f3f4f6', // Light border // gray-100
				brl200: '#e5e7eb', // Light border // gray-200
				brl300: '#d1d5db', // Light border // gray-300
				brl400: '#9ca3af', // Light border // gray-400
				brl500: '#6b7280', // Light border // gray-300
				brd: '#374151', // Dark border // gray-700

				// Ring:
				ringl: '#334155', // Light ring // slate 700
				ringd: '#e2e8f0', // Dark ring // slate 200

				// Divider:
				dvL300: '#d1d5db', // gray 300
				dvD500: '#6b7280', // gray 500
				dvD700: '#374151', // gray 700

				// Resources:
				policy: '#0e9f6e', // Text policy
				user: '#ff771f', // Text user
				group: '#475EE9', // Text group
				variable: '#9061f9', // Text variable
				host: '#bd4040', // Text host
				layer: '#A3B763', // Text layer
				webservice: '#87C4FF' // Text webservice
			}
		}
	},
	darkMode: 'class',
